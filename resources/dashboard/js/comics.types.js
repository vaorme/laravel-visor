...
axios.defaults.baseURL = axios.defaults.baseURL + '/space/comics/types';
			...
			<form action="" id="modalForm" class="frmo-modal${isItemEdit? ' update' : ''}" enctype="multipart/form-data">
				<div class="row row-cards">
					...
					<div class="col-12">
						...
						<textarea class="form-control" rows="4" name="description">${item && item.description? item.description : ''}</textarea>
					</div>
				</div>
			</form>
		</div>
