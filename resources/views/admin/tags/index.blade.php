<x-admin-layout>
    <x-admin.bar title="Tags" :buttonTo="route('tags.create')" buttonText="Crear tag">
    </x-admin.bar>
    <div class="contain">
        @if ($loop->isNotEmpty())
        <div class="table">
            <table id="tablr">
                ...
                <tbody>
                    @foreach ($loop as $i)
                            ...
                            <td>
                                <div class="buttons">
                                    <form action="{{ route('users.destroy', ['id' => $i->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit">
                                    ...
                                    <a href="{{ route('users.edit', ['id' => $i->id]) }}">
