                    ...
                    <tbody>
                        @foreach ($loop as $i)
                            <tr>
                                ...
                                <td>
                                    <div class="buttons">
                                        @can('manga_book_status.destroy')
                                            <a href="{{ route('manga_book_status.index') }}" class="mangaStatusDelete" data-id="{{ $i->id }}">
                                        ...
                                        @endcan
                                        @can('manga_book_status.edit')
                                            <a href="{{ route('manga_book_status.index', ['id' => $i->id]) }}">
